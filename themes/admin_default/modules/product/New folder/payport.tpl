	...
	<table class="table table-striped table-bordered table-hover">
		<tbody>
			<tr>
				...
				<td><input name="paymentname" value="{DATA.paymentname}" class="form-control input-sm" style="width: 400px;"></td>
			</tr>
			<tr>
				<td>{LANG.domain}</td>
				<td><input name="domain" value="{DATA.domain}" class="form-control input-sm" style="width: 400px;"></td>
			</tr>
			<tr>
				<td>{LANG.active}</td>
			...
			<tr>
				<td>{CONFIG_LANG}</td>
				<td><input name="config[{CONFIG_NAME}]" value="{CONFIG_VALUE}" class="form-control input-sm" style="width: 400px;"></td>
			</tr>
			<!-- END: config -->
			<tr>
				<td>{LANG.images_button}</td>
				<td><input class="form-control input-sm" style="width:400px" type="text" name="images_button" id="homeimg" value="{DATA.images_button}"/><input type="button" value="{LANG.browse_image}" name="selectimg" class="btn btn-info btn-sm" style="margin-left: 5px" /></td>
			</tr>
			<tr>
				<td><input name="payment" value="{DATA.payment}" type="hidden"></td>
				<td><input class="btn btn-primary btn-sm" type="submit" value="{LANG.save}" name="saveconfigpaymentedit"></td>
			<tr>
		</tbody>
	</table>
</form>
