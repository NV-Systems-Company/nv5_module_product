				...
				<table class="table table-bordered table-hover">
					<thead>
						<tr>
							...
							<td class="text-left"><a href="{URL_NAME}">{LANGE.column_group}</a> </td>
...
function delete_filter_group(filter_group_id, token) {
	if(confirm('{LANG.confirm}')) {
		$.ajax({
			url: script_name + '?' + nv_name_variable + '=' + nv_module_name + '&' + nv_fc_variable + '=filter_group&action=delete&nocache=' + new Date().getTime(),
			type: 'post',
			dataType: 'json',
