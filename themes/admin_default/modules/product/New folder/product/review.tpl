				...
				<table class="table table-bordered table-hover">
					<thead>
						<tr>
							...
							<td class="text-left"><a href="{URL_PRODUCT}" class="{SORT_PRODUCT}">{LANGE.column_product}</a> </td>
							<td class="text-left"><a href="{URL_CUSTOMER_NAME}" class="{SORT_CUSTOMER_NAME}" >{LANGE.column_customer_name}</a> </td>
							<td class="text-right"><a href="{URL_RATING}" class="{SORT_RATING}">{LANGE.column_rating}</a> </td>
 							<td class="text-center"><a href="{URL_STATUS}" class="{SORT_STATUS}">{LANGE.column_status}</a> </td>
  							<td class="text-center"><a href="{URL_DATE_ADDED}" class="{SORT_DATE_ADDED}">{LANGE.column_date_added}</a> </td>
 							<td class="text-right"> <strong>{LANGE.column_action} </strong></td>
						</tr>
					</thead>
					<tbody>
						 <!-- BEGIN: loop --> 
						<tr id="group_{LOOP.review_id}">
							<td class="text-center">
								<input type="checkbox" name="selected[]" value="{LOOP.review_id}"> 
							</td>
							<td class="text-left">{LOOP.name}</td>
							<td class="text-left">{LOOP.customer_name}</td>
							<td class="text-right">{LOOP.rating}</td>
							...
							<td class="text-center">{LOOP.date_added}</td>
 							<td class="text-right">
								...
								&nbsp;&nbsp;
								<a href="javascript:void(0);" onclick="delete_review('{LOOP.review_id}', '{LOOP.token}')" data-toggle="tooltip" title="{LANG.delete}" class="btn btn-danger btn-sm"><i class="fa fa-trash-o"></i>
