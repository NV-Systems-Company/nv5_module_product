...
<table class="table table-striped table-bordered table-hover" style="margin-bottom:0">
	<tbody>
		<tr>
			...
			<td>
			<select class="form-control input-sm" name="catid" style="width:300px" onChange="changecatid (this)">
				<!-- BEGIN: rowscat -->
...
<form class="form-inline" action="" method="post"><input name="save" type="hidden" value="1" />
	<table summary="{DATA.caption}" class="table table-striped table-bordered table-hover">
		...
		<tfoot>
			<tr>
				<td colspan="2"><input class="btn btn-primary btn-sm" name="submit" type="submit" value="{LANG.prounit_save}" /></td>
			</tr>
		</tfoot>
		<tr>
			<td align="right" width="180px"><strong>{LANG.topic_title}: </strong></td>
			<td><input class="form-control input-sm" style="width:50%" name="title" type="text" value="{DATA.title}" maxlength="255" /></td>
		</tr>
		<tr>
			<td align="right"><strong>{LANG.alias}: </strong></td>
			<td><input class="form-control input-sm" style="width:50%" name="alias" type="text" value="{DATA.alias}" maxlength="255" /></td>
		</tr>
		<tr>
