...
<div id="productcontent">
	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			<form action="" method="post" enctype="multipart/form-data" id="form-weight-class" class="form-horizontal"> <input type="hidden" name="weight_class_id" value="{DATA.weight_class_id}" /> <input name="save" type="hidden" value="1" />
				<div class="tab-content">
					<div class="form-group required"> <label class="col-sm-4 control-label">{LANGE.entry_title}</label>
						<div class="col-sm-20" style="padding-left: 0;">
							<!-- BEGIN: looplang -->
							<div class="input-group"> <span class="input-group-addon"><img src="{LANG_IMAGE}" title="{LANG_TITLE}" /></span> <input type="text" name="weight_class_description[{LANG_ID}][title]" value="{VALUE.title}" placeholder="{LANGE.entry_title}" class="form-control input-sm"> </div>
							<!-- BEGIN: error_title -->
					...
					<div class="form-group required"> <label class="col-sm-4 control-label">{LANGE.entry_unit}</label>
						<div class="col-sm-20" style="padding-left: 0;">
							<!-- BEGIN: looplang1 -->
							<div class="input-group"> <span class="input-group-addon"><img src="{LANG_IMAGE}" title="{LANG_TITLE}" /></span> <input type="text" name="weight_class_description[{LANG_ID}][unit]" value="{VALUE.unit}" placeholder="{LANGE.entry_unit}" class="form-control input-sm"> </div>
							<!-- BEGIN: error_unit -->
