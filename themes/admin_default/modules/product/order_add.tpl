	...
	<div class="panel panel-default">
		<div class="panel-heading">
			...
			<div class="pull-right">
				...
				<a href="{BACK}" data-toggle="tooltip" class="btn btn-default btn-sm" data-original-title="{LANG.button_cancel}"><i class="fa fa-reply"></i></a>
			</div>
			...
			<form class="form-horizontal">
					...
					<div class="tab-content">
						...
						<div class="row">
							...
							<div class="col-sm-12 text-right">
								<button type="button" id="button-refresh" data-loading-text="{LANG.text_loading}" class="btn btn-warning"><i class="fa fa-refresh"></i></button>
