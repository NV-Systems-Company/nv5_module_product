	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			<form action="" method="post" enctype="multipart/form-data" id="form-attribute-group" class="form-horizontal">
				<input type="hidden" name="attribute_group_id" value="{DATA.attribute_group_id}" />
					...
					<div class="form-group required">
						...
						<div class="col-sm-20">
							...
							<div class="input-group"> <span class="input-group-addon"><img src="{LANG_IMAGE}" title="{LANG_TITLE}" /></span>
								<input type="text" name="attribute_group_description[{LANG_ID}][name]" value="{VALUE.name}" placeholder="{LANGE.entry_name}" class="form-control input-sm">
							</div>
							<!-- BEGIN: error_name -->
