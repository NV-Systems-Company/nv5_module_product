                ...
                <form action="" method="post"  enctype="multipart/form-data" id="form-block" class="form-horizontal">
                    ...
                    <div class="tab-content">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane" id="language{LANG_ID}">
                                    <div class="form-group required">
                                        ...
                                        <div class="col-sm-20">
                                            <input type="text" name="block_cat_description[{LANG_ID}][name]" value="{VALUE.name}" placeholder="{LANGE.entry_name}" id="input-name{LANG_ID}" class="form-control input-sm" />
                                    ...
                                    <div class="form-group required">
                                        ...
                                        <div class="col-sm-20">
                                            	<input class="form-control input-sm w500 pull-left" name="block_cat_description[{LANG_ID}][alias]" placeholder="{LANGE.entry_alias}" type="text" value="{VALUE.alias}" maxlength="255" id="input-alias{LANG_ID}"/>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-20">
                                            <textarea name="block_cat_description[{LANG_ID}][description]" placeholder="{LANGE.entry_description}" id="input-description{LANG_ID}" class="form-control input-sm">{VALUE.description}</textarea>
                        ...
                        <div class="tab-pane fade" id="tab-data">
                            <div class="form-group">
                                <label class="col-sm-4 control-label" for="input-adddefault">{LANGE.entry_adddefault}</label>
                                <div class="col-sm-20">
                                    <select name="adddefault" id="input-adddefault" class="form-control input-sm">
                                         <!-- BEGIN: adddefault -->
                                        <option value="{DEFAULT.key}" {DEFAULT.selected}>{DEFAULT.name}</option>
										 <!-- END: adddefault -->
                                    </select>
                                </div>
                            </div>
