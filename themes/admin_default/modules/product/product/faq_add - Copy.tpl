            ...
            <div class="panel-body">
                <form action="" method="post" enctype="multipart/form-data" id="form-review" class="form-horizontal">
					...
					<div class="form-group required">
						...
						<div class="col-sm-20">
							<textarea name="question" cols="60" rows="3" placeholder="{LANGE.entry_question}" id="input-text" class="form-control input-sm">{DATA.question}</textarea>	
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-4 control-label" for="input-text">{LANGE.entry_answer}</label>
						<div class="col-sm-20">
							<textarea name="answer" cols="60" rows="8" placeholder="{LANGE.entry_answer}" id="input-text" class="form-control input-sm">{DATA.answer}</textarea>
						</div>
					</div>
