                    ...
                    <div class="tab-content">
							...
							<div class="tab-content">
                                ...
                                <div class="tab-pane" id="language{LANG_ID}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-20">
                                            <textarea name="product_description[{LANG_ID}][meta_description]" rows="5" placeholder="{LANGE.entry_meta_description}" id="input-meta-description{LANG_ID}" class="form-control input-sm">{VALUE.meta_description}</textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label" for="input-meta-keyword{LANG_ID}">{LANGE.entry_meta_keyword}</label>
                                        <div class="col-sm-20">
                                            <textarea name="product_description[{LANG_ID}][meta_keyword]" rows="5" placeholder="{LANGE.entry_meta_keyword}" id="input-meta-keyword{LANG_ID}" class="form-control input-sm">{VALUE.meta_keyword}</textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label" for="input-tag{LANG_ID}"><span data-toggle="tooltip" title="{LANGE.help_tag}">{LANGE.entry_tag}</span>
                                        </label>
                                        <div class="col-sm-20">
											<div id="product_description{LANG_ID}" class="tokenarea">
												<!-- BEGIN: keywords -->
												<span class="uiToken removable" title="{KEYWORDS}">
													{KEYWORDS}
													<input type="hidden" autocomplete="off" name="product_description[{LANG_ID}][tag][]" value="{KEYWORDS}" />
											...
											<div class="uiTypeahead">
												<div class="wrap">
													...
													<div class="innerWrap">
														<input id="keywords-search{LANG_ID}" type="text" placeholder="{LANGE.entry_tag}" class="form-control input-sm textInput" style="width: 100%;" />
													</div>
												</div>
											</div>
                                         </div>
						...
						<div class="tab-pane" id="tab-data">
                            <div class="form-group">
                                ...
                                <div class="col-sm-20">
                                    <img id="imagesourse" width="100" src="{NV_BASE_SITEURL}themes/{THEME}/images/{MODULE_FILE}/no_image.png" alt="" title="" data-placeholder="{NV_BASE_SITEURL}themes/{THEME}/images/{MODULE_FILE}/no_image.png" />
                                    
                                    <input class="form-control input-sm" style="width:400px; margin-right: 5px; display: inline-block" placeholder="{LANGE.entry_image}" type="text" name="homeimg" id="homeimg" value="{DATA.homeimgfile}"/>
									<input type="button" value="{LANG.browse_image}" name="selectimg" class="btn btn-info btn-sm" style="margin-right: 5px" />
									<script type="text/javascript">
										function Refresh()
										{
											var img = $('#homeimg').val();
											var oldimage = $('#imagesourse').attr('src');											
											if( img != '' && oldimage != img) $("#imagesourse").attr('src', img);	
										}
                           ...
                           <div class="form-group">
                            ...
                            <div class="form-group required">
                                ...
                                <div class="col-sm-20">
                                    <input type="text" name="price" value="{DATA.price}" placeholder="{LANGE.entry_price}" id="input-price" class="form-control input-sm w100" style="display:inline-block"/> 
									<input type="checkbox" name="showprice" value="1" {ck_showprice} id="input-showprice" class="form-control input-sm" /> {LANGE.entry_showprice}
							...
							<div class="form-group">
								...
								<div class="col-sm-20">
									<select name="tax_class_id" id="input-tax-class" class="form-control input-sm">
										...
										<!-- BEGIN: tax_class -->
										<option value="{TAX_CLASS.tax_class_id}" {TAX_CLASS.selected}>{TAX_CLASS.name}</option>
										<!-- END: tax_class -->
									</select>
								</div>
							</div>
							...
							<div class="form-group">
                                <label class="col-sm-4 control-label">{LANGE.entry_unit}</label>
                                <div class="col-sm-20">
                                    ...
                                    <!-- BEGIN: error_unit --><div class="text-danger">{error_unit}</div><!-- END: error_unit -->
                                </div>
                            </div>						
							<div class="form-group">
                                ...
                                <div class="col-sm-20">
                                    <select name="stock_status_id" id="input-stock-status" class="form-control input-sm">
                                        <!-- BEGIN: stock -->
										<option value="{STOCK.stock_status_id}" {STOCK.selected}>{STOCK.name}</option>
										<!-- END: stock -->
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-20">
									...
									<label class="radio-inline">
                                        <input type="radio" name="shipping" value="{SHIPPING.shipping}" {SHIPPING.checked} /> {SHIPPING.name} 
									</label>
									<!-- END: shipping -->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-20">
                                    <select class="form-control input-sm" name="brand_id" >
										...
										<!-- BEGIN: brand -->
										<option value="{FACTURER.brand_id}" {FACTURER.selected} >{FACTURER.name}</option>
										<!-- END: brand -->
									</select>
                                </div>
                            </div>
								...
								<table id="attribute" class="table table-striped table-bordered table-hover">
									...
									<tbody>
										...
										<tr id="attribute-row{ATB.key}">
											<td class="text-left">
												<input type="text" name="product_attribute[{ATB.key}][name]" value="{ATB.name}" placeholder="{LANGE.entry_attribute}" class="form-control input-sm" autocomplete="off">
											...
											<td class="text-left">
												...
												<div class="input-group"><span class="input-group-addon"><img src="{LANG_IMAGE}" title="{LANG_TITLE}"></span>
													<textarea name="product_attribute[{ATB.key}][product_attribute_description][{LANG_ID}][text]" rows="2" placeholder="{LANGE.entry_text}" class="form-control input-sm">{TEXT}</textarea>
												</div>
												<!-- END: languages -->
											</td>
											<td class="text-left">
												<button type="button" onclick="$('#attribute-row{ATB.key}').remove();" data-toggle="tooltip" title="{LANG.remove}" class="btn btn-danger btn-sm"><i class="fa fa-minus-circle"></i>
												</button>
											</td>
										</tr>
									...
									<tfoot>
										<tr>
											<td colspan="2"></td>
											<td class="text-left">
												<button type="button" onclick="addAttribute();" data-toggle="tooltip" class="btn btn-primary btn-sm" title="{LANGE.entry_attribute_add}"><i class="fa fa-plus-circle"></i>
												</button>
											</td>
										</tr>
									</tfoot>
												...
												<table id="option-value{OPTION.num}" class="table table-striped table-bordered table-hover">
													...
													<!-- BEGIN:loop -->
														<tr id="option-value-row{OPTIONVALUE.option_value_row}">
															...
															<td class="text-right">
																<input type="text" name="product_option[{OPTION.num}][product_option_value][{OPTIONVALUE.option_value_row}][quantity]" value="{OPTIONVALUE.quantity}" placeholder="Quantity" class="form-control input-sm" />
															</td>
															<td class="text-left">
															...
															<td class="text-right">
																...
																<input type="text" name="product_option[{OPTION.num}][product_option_value][{OPTIONVALUE.option_value_row}][price]" value="{OPTIONVALUE.price}" placeholder="Price" class="form-control input-sm" />
															</td>
															<td class="text-right">
																...
																<input type="text" name="product_option[{OPTION.num}][product_option_value][{OPTIONVALUE.option_value_row}][points]" value="{OPTIONVALUE.points}" placeholder="Points" class="form-control input-sm" />
															</td>
															<td class="text-right">
																...
																<input type="text" name="product_option[{OPTION.num}][product_option_value][{OPTIONVALUE.option_value_row}][weight]" value="{OPTIONVALUE.weight}" placeholder="Weight" class="form-control input-sm" />
															</td>
															<td class="text-left">
													...
													<tfoot>
														<tr>
															<td colspan="6"></td>
															<td class="text-left">
																<button type="button" onclick="addOptionValue('{OPTION.num}');" data-toggle="tooltip" title="{LANGE.entry_add_option_value}" class="btn btn-primary btn-sm"><i class="fa fa-plus-circle"></i>
																</button>
															</td>
														</tr>
													</tfoot>
                                ...
                                <table id="images" class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
										...
										<tr id="image-row{IMG.key}">
											<td class="text-left">
												<input type="button" class="btn btn-primary btn-sm" value="{LANGE.entry_select_image}" name="selectfile" onclick="nv_open_browse( '{NV_BASE_ADMINURL}index.php?{NV_NAME_VARIABLE}=upload&popup=1&area=input-image{IMG.key}&path={NV_UPLOADS_DIR}/{module_name}&currentpath={CURRENT}&type=file', 'NVImg', 850, 500, 'resizable=no,scrollbars=no,toolbar=no,location=no,status=no' ); return false; ">
												<input type="text" name="product_image[{IMG.key}][image]" value="{IMG.value.image}" id="input-image{IMG.key}" class="form-control input-sm inputimage">
											</td>
											<td class="text-right">
									...
									<tbody>
										...
										<tr id="video-row{VIDEO.key}">
											...
											<td class="col-sm-3 text-left">
												...
												<a class="get-info" onclick="get_info_video({VIDEO.key})" href="javascript:void(0);" style="padding: 2px 10px; border: 1px #3276b1; background:#3276b1; color:#fff">Lấy thông tin</a> 
											</td>
						...
						<div class="text-center" style="margin-top: 10px">
							...
							<a href="{CANCEL}"  class="btn btn-default btn-sm" title="{LANG.cancel}">{LANG.cancel} </a>
...
<!-- BEGIN: languages_tag -->
<script type="text/javascript">
    $("#keywords-search{LANG_ID}").bind("keydown", function(event) {
        if (event.keyCode === $.ui.keyCode.TAB && $(this).data("ui-autocomplete").menu.active) {
            event.preventDefault();
        }

        if (event.keyCode == 13) {
            var keywords_add = $("#keywords-search{LANG_ID}").val();
            keywords_add = trim(keywords_add);
            if (keywords_add != '') {
                nv_add_element('product_description', '{LANG_ID}', keywords_add, keywords_add);
                $(this).val('');
            }
            return false;
        }
        ...
        source: function(request, response) {
            $.getJSON(script_name + "?" + nv_name_variable + "=" + nv_module_name + "&" + nv_fc_variable + "=product&get_tags=1", {
        ...
        select: function(event, ui) {
            if (event.keyCode != 13) {
                nv_add_element('product_description', '{LANG_ID}', ui.item.value, ui.item.value);
                $(this).val('');
            }
            return false;
        }
    });
    $("#keywords-search{LANG_ID}").blur(function() {
        var keywords_add = $("#keywords-search{LANG_ID}").val();
        keywords_add = trim(keywords_add);
        if (keywords_add != '') {
            nv_add_element('product_description', '{LANG_ID}', keywords_add, keywords_add);
    ...
    $("#keywords-search{LANG_ID}").bind("keyup", function(event) {
        var keywords_add = $("#keywords-search{LANG_ID}").val();
        if (keywords_add.search(',') > 0) {
            ...
            for (i = 0; i < keywords_add.length; i++) {
                ...
                if (str_keyword != '') {
                    nv_add_element('product_description', '{LANG_ID}', str_keyword, str_keyword);
                }
            }
            $(this).val('');
        }
...
$('input[name=\'related\']').autofill({
	'source': function(request, response) {
		$.ajax({
			url: '{JSON_RELATED}&filter_name=' +  encodeURIComponent(request),
			dataType: 'json',			
			success: function(json) {
				response($.map(json, function(item) {
					return {
...
$('input[name=\'option\']').autofill({
    'source': function(request, response) {
        $.ajax({
            url: '{JSON_OPTION}&filter_name=' + encodeURIComponent(request),
            dataType: 'json',
            success: function(json) {
                response($.map(json, function(item) {
                    return {
    ...
    'select': function(item) {
        ...
        if (item['type'] == 'select' || item['type'] == 'radio' || item['type'] == 'checkbox' || item['type'] == 'image') {
            ...
            html += '  	 <thead>';
            html += '      <tr>';
            html += '        <td class="text-left">{LANGE.entry_option_value}</td>';
            html += '        <td class="text-right">{LANGE.entry_quantity}</td>';
            html += '        <td class="text-left">{LANGE.entry_subtract}</td>';
            html += '        <td class="text-right">{LANGE.entry_price}</td>';
            html += '        <td class="text-right">{LANGE.entry_points}</td>';
            html += '        <td class="text-right">{LANGE.entry_weight}</td>';
            html += '        <td></td>';
            html += '      </tr>';
            html += '  	 </thead>';
            html += '  	 <tbody>';
...
<script type="text/javascript">
	...
	function addImage() {
		...
		html += '  <input type="button" class="btn btn-primary btn-sm" value="{LANGE.entry_select_image}" name="selectfile" onclick="nv_open_browse( \'{NV_BASE_ADMINURL}index.php?{NV_NAME_VARIABLE}=upload&popup=1&area=input-image' + image_row + '&path={NV_UPLOADS_DIR}/{module_name}&currentpath={CURRENT}&type=file\', \'NVImg\', 850, 500, \'resizable=no,scrollbars=no,toolbar=no,location=no,status=no\' ); return false; ">';
		html += '  <input type="text" name="product_image[' + image_row + '][image]" value="" id="input-image' + image_row + '" placeholder="{LANGE.entry_image}" class="form-control input-sm inputimage"/></td>';
...
<script type="text/javascript">
    ...
    function addAttribute() {
        ...
        html += '  <td class="text-left"><input type="text" name="product_attribute[' + attribute_row + '][name]" value="" placeholder="{LANGE.entry_attribute}" class="form-control input-sm" /><input type="hidden" name="product_attribute[' + attribute_row + '][attribute_id]" value="" /></td>';
        html += '  <td class="text-left">';
		<!-- BEGIN: languages_attribute -->
        html += '<div class="input-group"><span class="input-group-addon"><img src="{LANG_IMAGE}" title="{LANG_TITLE}" /></span><textarea name="product_attribute[' + attribute_row + '][product_attribute_description][{LANG_ID}][text]" rows="2" placeholder="{LANGE.entry_text}" class="form-control input-sm"></textarea></div>';
    ...
    function attributeautocomplete(attribute_row) {
        $('input[name=\'product_attribute[' + attribute_row + '][name]\']').autofill({
            'source': function(request, response) {
                $.ajax({
                    url: '{JSON_ATTRIBUTE}&filter_name=' + encodeURIComponent(request),
                    dataType: 'json',
                    success: function(json) {
                        response($.map(json, function(item) {
                            return {
...
<script type="text/javascript">
    ...
    function addVideo() {
		...
		html += '        <a class="get-info" onclick="get_info_video(' + video_row + ')" href="javascript:void(0);" style="padding: 2px 10px; border: 1px #3276b1; background:#3276b1; color:#fff" >Lấy thông tin</a>';
		html += '    </td>';
	...
	$('[type="submit"]').hover(function(){
		if( $('[name="keywords[]"]').length == 0 ){
			if( $('#message-tags').length == 0 ){
				$('#message').html('<div style="margin-top: 10px" id="message-tags" class="alert alert-danger">{LANGE.entry_tags_empty}.<!-- BEGIN: auto_tags --> {LANGE.entry_tags_empty_auto}.<!-- END: auto_tags --></div>');
			}
		}else{
			$('#message-tags').remove();
		}
