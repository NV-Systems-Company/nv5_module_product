        ...
        <div class="panel-body">
			<form action="" method="post" enctype="multipart/form-data" id="form-flat" class="form-horizontal">
				...
				<div class="form-group">
					...
					<div class="col-sm-20">
						<select name="reward_status" id="input-status" class="form-control input-sm">
							<!-- BEGIN: reward_status -->
				...
				<div class="form-group">
					...
					<div class="col-sm-20">
						<input type="text" name="reward_sort_order" value="{DATA.reward_sort_order}" placeholder="{LANGP.entry_sort_order}" id="input-sort-order" class="form-control input-sm">	
					</div>
				</div>
			</form>
		</div>
