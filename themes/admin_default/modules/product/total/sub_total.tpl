		...
		<div class="panel-body">
			<form action="" method="post" enctype="multipart/form-data" id="form-flat" class="form-horizontal">
				...
				<div class="form-group">
					...
					<div class="col-sm-20">
						<select name="sub_total_status" id="input-status" class="form-control input-sm">
							<!-- BEGIN: sub_total_status -->
							<option value="{STATUS.key}" {STATUS.selected}>{STATUS.name}</option>
							<!-- END: sub_total_status -->
						</select>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-20">
						<input type="text" name="sub_total_sort_order" value="{DATA.sub_total_sort_order}" placeholder="{LANGP.entry_sort_order}" id="input-sort-order" class="form-control input-sm">	
					</div>
				</div>
			</form>
		</div>
