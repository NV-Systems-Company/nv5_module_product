...
<div class="row">
    <div class="col-sm-12">
        <fieldset id="account">
            ...
            <div class="form-group required">
                <label class="control-label" for="input-payment-email">{LANGE.entry_email}</label>
                <input type="text" name="email" value="" placeholder="{LANGE.entry_email}" id="input-payment-email" class="form-control input-sm" />
            </div>
            <div class="form-group required">
    ...
    <div class="col-sm-12">
        <fieldset id="address">
            <legend>{LANGE.text_your_address}</legend>
            <div class="form-group">
...
<div class="checkbox">
	<label>
        <input type="checkbox" name="shipping_address" value="1" {shipping_address_checked}>
        {LANGE.entry_shipping}
	</label>
</div>
<!-- END: shipping_address -->
<div class="buttons">
    <div class="pull-right">
        <input type="button" value="{LANG.button_continue}" id="button-guest" data-loading-text="{LANG.button_loading}" class="btn btn-primary" />
    </div>
</div>
