        ...
        <div class="panel-body">
            ...
            <form class="form-horizontal">
                ...
                <div class="form-group required">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="postcode" value="{SHIP_ADD.postcode}" placeholder="Post Code" id="input-postcode" class="form-control input-sm" />
                    </div>
                </div>
            ...
            <script type="text/javascript">
                $('#button-quote').on('click', function() {
                    $.ajax({
                        url: nv_siteroot + 'index.php?' + nv_lang_variable + '=' + nv_sitelang + '&' + nv_name_variable + '=' + nv_module_name + '&' + nv_fc_variable + '=shipping&action=quote&nocache=' + new Date().getTime(),
                        type: 'post',
                ...
                $(document).delegate('#button-shipping', 'click', function() {
                    $.ajax({
                        url: nv_siteroot + 'index.php?' + nv_lang_variable + '=' + nv_sitelang + '&' + nv_name_variable + '=' + nv_module_name + '&' + nv_fc_variable + '=shipping&action=shipping&nocache=' + new Date().getTime(),
                        type: 'post',
            ...
            <script type="text/javascript">
                $('select[name=\'country_id\']').on('change', function() {
                    $.ajax({
                        url: nv_siteroot + 'index.php?' + nv_lang_variable + '=' + nv_sitelang + '&' + nv_name_variable + '=' + nv_module_name + '&' + nv_fc_variable + '=shipping&action=zone&country_id=' + this.value + '&nocache=' + new Date().getTime(),
                        dataType: 'json',
                        beforeSend: function() {
                        ...
                        success: function(json) {
                            ...
                            if (json['zone']) {
                                for (i = 0; i < json['zone'].length; i++) {
                                    ...
                                    if (json['zone'][i]['zone_id'] == '{SHIP_ADD.zone_id}') {
